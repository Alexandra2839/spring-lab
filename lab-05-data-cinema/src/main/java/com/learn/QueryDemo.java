...
public class QueryDemo implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        System.out.println(movieRepository.listAllMovieName());
        System.out.println(movieCinemaRepository.countByCinema_Id(4L));
        System.out.println(movieCinemaRepository.listAllByLocationName("AMC Empire 25"));
        System.out.println(ticketRepository.listTicketsByUserId(4L));
        System.out.println(ticketRepository.listAllTicketsBetweenDates(LocalDateTime.now().minusDays(1000), LocalDateTime.now()));
